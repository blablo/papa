...
$(document).ready ->
  ...
  $(".submenu .thumbnail").click ->
    ...
    $("#sale_list .fields :last .precio").html($(this).attr('price'))
    $("#sale_list .fields :last .precio").formatCurrency()
    $("#sale_list .fields :last .p_name").html($(this).attr('name'))
    $("#sale_list .fields :last .f_precio").val($(this).attr('price'))
    $("#sale_list .fields :last .f_product").val($(this).attr('product_id'))
    cantidad = parseInt($("#display").val())
    cantidad = 1  if isNaN(cantidad)
    valor = cantidad * parseFloat($(this).attr('price'))
    console.log cantidad
    $("#sale_list .fields :last .cantidad").html(cantidad)
    $("#sale_list .fields :last .f_cantidad").val(cantidad)
    $("#sale_list .fields :last .valor").html(valor)
    $("#sale_list .fields :last .valor").formatCurrency()
    $("#sale_list .fields :last .f_valor").val(valor)
    $("#display").val("")
  ...
  $("#numpad .minus").click ->
    ...
    if isNaN(dinero) == false
      $(".add_nested_fields").click()
      $("#sale_list .fields :last .p_name").html('-')
      $("#sale_list .fields :last .f_product").val('')
      $("#sale_list .fields :last .precio").html(dinero)
      $("#sale_list .fields :last .precio").formatCurrency()
      $("#sale_list .fields :last .f_precio").val(dinero)
      $("#sale_list .fields :last .cantidad").html("1")
      $("#sale_list .fields :last .f_cantidad").val("1")
      $("#sale_list .fields :last .valor").html(dinero)
      $("#sale_list .fields :last .valor").formatCurrency()
      $("#sale_list .fields :last .f_valor").val(dinero)
      $("#display").val("")
      $(".total span").html(getTotal())
      $("#moneypad .dado span").html(getTotal())
      $(".total span").formatCurrency()
